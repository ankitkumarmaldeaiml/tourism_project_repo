...
mlflow.set_experiment("tourism-package-predictor-experiment")

api = HfApi()



Xtrain_path = "hf://datasets/AnkitkumarMalde/tourism-package-predictor/Xtrain.csv"
Xtest_path = "hf://datasets/AnkitkumarMalde/tourism-package-predictor/Xtest.csv"
ytrain_path = "hf://datasets/AnkitkumarMalde/tourism-package-predictor/ytrain.csv"
ytest_path = "hf://datasets/AnkitkumarMalde/tourism-package-predictor/ytest.csv"
...
categorical_features = [
    'CityTier',          # categorization of city in (Tier 1 > Tier 2 > Tier 3)
    'Passport',          # Whether the customer holds a valid passport (0: No, 1: Yes)
    'OwnCar',            # Whether the customer owns a car (0: No, 1: Yes)
    'TypeofContact',     # Method via which customer contacted (Company Invited or Self Inquiry)
...
with mlflow.start_run():
    ...
    repo_id = "AnkitkumarMalde/churn-model"
    repo_type = "model"
